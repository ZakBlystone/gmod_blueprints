...
local function LoadDefinitionPack(data)
	...
	defpack:PostInit()
	print(defpack:ToString())
	ready = true

end

local data = file.Read(DEFPACK_LOCATION, "DATA")
if data then
	print("LOADING DEFINITION PACK: " .. DEFPACK_LOCATION)
	LoadDefinitionPack(data)
else
	print("Unable to load definition pack at: " .. DEFPACK_LOCATION)
end
